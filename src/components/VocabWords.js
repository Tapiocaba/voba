const vocabWords = {
  '1': [
    { word: 'ant', definition: 'A tiny insect that lives in a colony. Ants can carry objects much heavier than themselves!', imageLink: 'https://www.nwf.org/-/media/NEW-WEBSITE/Shared-Folder/Wildlife/Invertebrates/invertebrate_wood-ants_600x300.jpg'},
    { word: 'bear', definition: 'A big, furry animal that can walk on two legs and loves to eat honey.', imageLink: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/2010-kodiak-bear-1.jpg/330px-2010-kodiak-bear-1.jpg'},
    { word: 'carrot', definition: 'A long, orange vegetable that grows underground. Rabbits love to eat them!', imageLink: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Vegetable-Carrot-Bundle-wStalks.jpg/330px-Vegetable-Carrot-Bundle-wStalks.jpg'  },
    {word: 'duck', definition: 'A bird that can swim, walk, and fly! Ducks love to be in water.', imageLink: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Bucephala-albeola-010.jpg/330px-Bucephala-albeola-010.jpg'},
    {word: 'egg', definition: 'A round object laid by birds. We can eat them or wait for them to hatch into baby birds.', imageLink: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Eggs_in_basket_2020_G1.jpg/330px-Eggs_in_basket_2020_G1.jpg'},
  ],
  '2': [
    { word: 'flower', definition: 'A colorful part of a plant that smells nice and can turn into fruit.', imageLink: 'https://images.pexels.com/photos/39517/rose-flower-blossom-bloom-39517.jpeg?cs=srgb&dl=pexels-pixabay-39517.jpg&fm=jpg'},
    { word: 'guitar', definition: 'A musical instrument with strings that you pluck or strum to make music.', imageLink: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/GuitareClassique5.png/229px-GuitareClassique5.png'},
    { word: 'hat', definition: 'Something you wear on your head to protect yourself from the sun or to look fashionable.', imageLink: 'https://strattonhats.com/wp-content/uploads/IMG_1416.jpg'},
